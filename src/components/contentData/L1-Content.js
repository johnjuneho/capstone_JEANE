...
export const L1Content = {
  content: [
    ...
    },
    {
      ...
      question: 'When asking ChatGPT questions, should you use a positive or negative tone for describing what you want??',
      choices: [
        {
    ...
    },
    {
      ...
      message: "Prompt engineering is a fundamental skill in harnessing the power of AI language models like Chat GPT. By mastering the art of crafting precise and contextually relevant prompts, you can unlock the full potential of these tools to assist you in a wide range of tasks and inquiries. Remember, clarity and specificity are key to getting the results you need. Happy prompting!"
    }
   ],
};
