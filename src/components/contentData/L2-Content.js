...
export const L2Content = {
  content: [
      ...
      choices: [
        {
          ...
          explanation: "Incorrect: This is like taking credit for someone else's work. It's not honest or fair."
        },
        {
          name: 'Using ChatGPT to generate ideas and develop your own understanding',
          explanation: "Correct: Just like brainstorming with a friend, using ChatGPT to spark ideas is great! You're learning and creating something new."
        },
        {
          name: 'Telling friends facts you got from ChatGPT without fact-checking ',
          explanation: "Incorrect: Sharing information without verifying its accuracy can lead to spreading misinformation. It's important to fact-check before sharing."
        }
      ],
      answerIndex: 1
    },
      ...
      choices: [
        {
          ...
          explanation: "Incorrect: While getting a second opinion can be helpful, it's crucial to fact-check with reliable sources"
        },
        {
          name: ' Nothing! ChatGpt is always right',
          explanation: "Incorrect: ChatGPT is a powerful tool, but it's not infallible. It's important to verify its responses."
        },
        {
          name: 'Ensure the answer is correct by fact-checking it online with multiple sources',
          explanation: "Correct: Fact-checking helps ensure that the information you received is accurate and reliable."
        },
      ],
      answerIndex: 2
    },
      ...
      choices: [
        {
          ...
          explanation: "Correct: Fact-checking involves confirming the accuracy of information by comparing it with reliable sources."
        },
        {
          name: 'Making up information ',
          explanation: "Incorrect: Fact-checking is the opposite of making up information. It's about ensuring the truthfulness of the information."
        },
        {
          name: 'Trusting information blindly ',
          explanation: "Incorrect: Fact-checking encourages skepticism and critical thinking, rather than blind trust."
        }
    ...
    },
    {
      type: "quiz",
      questionNumber: 5,
      question: "Which of the following is the best way to fact-check responses from ChatGPT?",
      choices: [
        {
          name: "Trust ChatGPT's responses",
          explanation: "Incorrect: Relying solely on ChatGPT's responses without verification can lead to inaccuracies and misinformation."
        },
        {
          name: ' Check one source from Google',
          explanation: "Incorrect: Depending on a single source for fact-checking may not provide a comprehensive understanding of the accuracy of the information."
        },
        {
          name: 'Double check the information with multiple reliable sources',
          explanation: "Correct! Fact-checking involves verifying information from multiple reliable sources to ensure its accuracy and reliability."
        }
      ],
      answerIndex: 2
    },
 {
      ...
      choices: [
        {
          ...
          explanation: "Correct! Fact-checking helps prevent the dissemination of rumors or false information by ensuring the accuracy and reliability of the information being shared."
        },
        {
          name: 'Making friends',
          explanation: "Incorrect: Fact-checking is unrelated to making friends. It is focused on verifying the accuracy of information."
        },
        {
          name: 'Eating snacks',
          explanation: "Incorrect: Fact-checking is unrelated to eating snacks. It is focused on verifying the accuracy and reliability of information."
        }
      ...
      choices: [
        {
          ...
          explanation: "Correct! Fact-checking ensures that the information you rely on for decision-making is accurate and reliable."
        },
        {
          name: 'By making decisions randomly',
          explanation: "Incorrect: Making decisions randomly is not a responsible approach. Fact-checking helps ensure informed decision-making based on accurate information."
        },
        {
          name: ' By avoiding information altogether',
          explanation: "Incorrect: Avoiding information altogether hinders informed decision-making. Fact-checking allows you to access reliable information for better decision-making."
        }
      ],
      answerIndex: 0
    },
    ...
    },
    {
      type: "quiz",
      questionNumber: 8,
      question: "You're writing an essay and ask ChatGPT for ideas. It provides a detailed outline. What should you do with the response?",
      choices: [
        {
          name: 'Use the outline as a reference to guide your own writing process.',
          explanation: "Correct: Using the outline as a reference allows you to incorporate ChatGPT's ideas into your own writing process while maintaining originality."
        },
  {
          name: ' Use the outline as-is for your essay.',
          explanation: "Incorrect: Using the outline as-is may not align with your own ideas or the requirements of your essay."
        },
        {
          name: 'Disregard the outline and ask ChatGPT for more ideas for the essay.',
          explanation: "Incorrect: Disregarding the outline without considering its value may overlook useful insights provided by ChatGPT."
        }
      ],
      answerIndex: 0
    },
    {
      type: "quiz",
      questionNumber: 9,
      question: " You ask ChatGPT for information about a historical event, and it provides a response. What should you do next?",
      choices: [
        {
          name: 'Use the response without verifying the information with other sources.',
          explanation: "Incorrect: You should never use Chat GPT’s response without verifying the information with other credible sources. It's like trusting someone without making sure they're telling the truth"
        },
  {
          name: "Assume ChatGPT's response is correct and move on to the next question and repeat.",
          explanation: "Incorrect: Assuming something is true without verifying it can lead to misinformation being spread. Always double-check the information provided by ChatGPT."
        },
        {
          name: 'Cross-reference the information with reliable sources to ensure accuracy',
          explanation: "Correct! Just as you would fact-check information from any source, it's important to confirm the information provided by ChatGPT with other reliable sources. This helps ensure accuracy and gives you a more complete understanding of the topic"
        }
      ],
      answerIndex: 2
    },
    {
      type: "quiz",
      questionNumber: 10,
      question: "You're studying for an exam and decide to use ChatGPT to test your knowledge. What should you be cautious about?",
      choices: [
        {
          name: "Over-reliance on ChatGPT's answers without verifying your understanding through practice.",
          explanation: "Incorrect: Almost there! It's crucial to be cautious about relying too much on ChatGPT's answers without practicing and understanding the material yourself. However, there's more to consider."
        },
        {
          name: "Trusting ChatGPT's responses blindly, assuming they are always correct.",
          explanation: "Incorrect: Not quite! It's definitely risky to trust ChatGPT's responses blindly, assuming they're always right. But there's other important cautions to keep in mind."
        },
        {
          name: 'All of the above',
          explanation: "Correct: You got it! When using ChatGPT for exam prep, it's crucial to avoid over-reliance, blind trust, and relying solely on ChatGPT without consulting other study materials. Great job!"
        }
      ],
      answerIndex: 2
    },
    {
      type: "end",
      lessonTitle: "Lesson 2:  What Do We Do With AI's Response Closing Thoughts",
      message: "Using ChatGPT can be a valuable tool for learning and exploring new ideas. However, it's important to use it responsibly and ethically. Remember to critically evaluate ChatGPT's responses, fact-check information from reliable sources, and avoid plagiarism by putting responses into your own words. By doing so, you'll enhance your understanding, develop critical thinking skills, and contribute to a trustworthy information environment."
    }
   ],
};
