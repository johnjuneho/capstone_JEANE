...
export const L3Content = {
  content: [
      ...
      choices: [
        {
          ...
          explanation: "That’s correct:  If you rely on ChatGPT without taking the time to learn the steps on how you got that answer, you may not know how to do it yourself and fully understand on how to solve the problem. This reduces your critical thinking skills and increases the potential for misinformation. It's like always taking the elevator and forgetting how to climb stairs."
        },
        {
          name: 'More accurate information.',
          explanation: "Not quite... AI can be a helpful tool, but overreliance might lead us to accept information without questioning its accuracy."
        },
        {
          name: 'Enhanced creativity and problem-solving skills.',
          explanation: "Not quite... While AI can inspire new ideas, overusing it may dampen our own creativity and problem-solving abilities."
        }
      ],
      answerIndex: 0 //whichever is correct answer so if specificity is correct, it is 0, if politness, it is 1
    },
    {
      type: 'quiz',
      questionNumber: 3, // Added question number
      question: 'Why is it important to understand the limitations of ChatGPT and other AI systems?',
      choices: [
        {
          name: 'To avoid relying too much on ChatGPT and encourage critical problem-solving skills beyond what AI systems can offer.',
          explanation: "Although this is important in understanding the limitations of AI, you should look at the other response options to see if they are also accurate as well!"
        },
        {
        ...
        },
        {
          ...
          explanation: "Correct! Knowing AI's limits helps us not to lean too much on it and keeps us learning and growing. It's like knowing when to ask a friend for help instead of always relying on a computer."
        }
      ],
      answerIndex: 2 //whichever is correct answer so if specificity is correct, it is 0, if politness, it is 1
    },
    {
      type: 'lecture',
    ...
    {
      type: 'quiz',
      questionNumber: 4, // Added question number
      question: 'What are biases?',
      choices: [
        {
          name: 'Ways that people and groups harm others through subconscious belief',
          explanation: "Biases are like invisible traps that can lead to unfairness, often without us knowing. They can sneak into AI like ChatGPT, affecting the fairness of the information we get."
        },
        {
          name: 'Objective and scientific viewpoints',
          explanation: "Not quite… being objective and having scientific viewpoints means that you have evidence to help support your claim and make a fair judgment."
        },
        {
          name: 'Flaws in AI systems',
          explanation: "Not quite… having flaws in AI systems are a result of having biases because it leads to unfairness and unsupported claims that can be harmful."
        }
      ],
      answerIndex: 0 //whichever is correct answer so if specificity is correct, it is 0, if politness, it is 1
    },
    {
      type: 'quiz',
      questionNumber: 5, // Added question number
      question: 'Are ChatGPT’s responses are biased?',
      choices: [
        {
          name: 'Yes, always.',
          explanation: "Not quite... While it's natural to wonder about bias, saying ChatGPT is always biased isn't accurate. Just like people, ChatGPT can sometimes be influenced by the information it's learned from. It's important to consider various factors and fact-check the information."
        },
        {
          name: 'No, never– ChatGPT is always reliable as it is constantly evolving and improving.',
          explanation: "Not quite... While ChatGPT is indeed constantly evolving and improving, it's not always completely unbiased. Just like us, it can sometimes be influenced by what it's learned. So, it's a good idea to double-check the information it provides."
        },
        {
          name: 'It depends on various factors so it is good to always fact-check.',
          explanation: "ChatGPT might give biased answers depending on what it learned from. It's like a parrot repeating words without knowing what they mean. We should always double-check the information."
        }
      ],
      answerIndex: 2 //whichever is correct answer so if specificity is correct, it is 0, if politness, it is 1
    },
    ...
    {
      type: 'quiz',
      questionNumber: 6, // Added question number
      question: 'How can biased answers affect the information you receive from ChatGPT?',
      choices: [
        {
          name: 'By presenting skewed or inaccurate perspectives',
          explanation: "Close, but not quite! Skewed and inaccurate perspectives can also lead to other harmful perceptions you may have on certain topics! What other ways can biases harm your perspectives on the information received from ChatGPT?"
        },
        {
          name: 'By limiting the diverse of viewpoints presented',
          explanation: "Close but not quite! When you have limited viewpoints, it may cause you to become biased and affect your perception. What other ways can biases harm your perspectives on the information received from ChatGPT?"
        },
        {
          name: 'All of the above',
          explanation: "Correct! Biased responses can give us a wonky view of the world, like looking through a bent mirror. They can reinforce unfair stereotypes or leave out important voices, making the information incomplete."
        }
      ],
      answerIndex: 2 //whichever is correct answer so if specificity is correct, it is 0, if politness, it is 1
    },
    ...
    {
      type: 'quiz',
      questionNumber: 7, // Added question number
      question: 'What is Plagiarism?',
      choices: [
        {
          name: 'Citing any sources used in your work',
          explanation: "That's not quite right. While citing sources is important to avoid plagiarism, it's not the definition of plagiarism itself. Plagiarism is actually when you copy someone else's work without giving them credit, like claiming you scored a goal when you didn't."
        },
        {
          name: 'Copying work that isn’t your own without giving credit',
          explanation: "Correct! Copying someone else's work without saying it's theirs is plagiarism. It's like taking credit for a goal you didn't score."
        },
        {
          name: 'Paraphrasing your own ideas.',
          explanation: "Close, but not quite! Paraphrasing your own ideas isn't plagiarism because you're not claiming someone else's work as your own."
        }
      ],
      answerIndex: 1 //whichever is correct answer so if specificity is correct, it is 0, if politness, it is 1
    },
    {
      type: 'quiz',
      questionNumber: 8, // Added question number
      ...
      choices: [
        {
          ...
          explanation: "While being mindful of your data privacy is important, honesty in using ChatGPT goes beyond just data management. It's more about maintaining integrity in the information you share."
        },
        {
          name: 'To maintain academic integrity and trustworthiness in the information shared.',
          explanation: "Honesty in using ChatGPT helps maintain the trust in our work and ensures we truly learn from our tasks. It's like building a tower with strong bricks instead of shaky ones; it stands tall and proud because it's built the right way."
        },
        {
          name: 'Because ChatGPT requires honesty in the user agreement.',
          explanation: "While honesty is typically outlined in user agreements, the importance of honesty extends beyond just following rules. It's about upholding integrity and trustworthiness in the information we create and share."
        }
      ],
      answerIndex: 1 //whichever is correct answer so if specificity is correct, it is 0, if politness, it is 1
    },
    ...
    {
      type: 'quiz',
      questionNumber: 9, // Added question number
      question: 'How can you use ChatGPT to help you learn without copying your answers?',
      choices: [
        {
          name: 'Utilize it as a tool for generating ideas and understanding concepts',
          explanation: "Close, but not quite! While using ChatGPT as a tool for generating ideas and understanding concepts is important, it's only part of the answer."
        },
        {
          name: 'Verify its responses with other sources and integrate them into your own words',
          explanation: "Almost there! Verifying ChatGPT's responses with other sources and integrating them into your own words is definitely a good idea, but what else could be important?"
        },
        {
          name: 'Correct: All of the above',
          explanation: "ChatGPT is a tool to spark ideas and help understand things better. But like using any tool, from pencils to computers, the real learning happens when we make the ideas our own."
        }
      ],
      answerIndex: 2 //whichever is correct answer so if specificity is correct, it is 0, if politness, it is 1
    },
    {
      type: 'quiz',
      questionNumber: 10, // Added question number
      question: 'How can ChatGPT affect your learning?',
      choices: [
        {
          name: 'Reducing your critical thinking and understanding when overused',
          explanation: "Close, but not quite! While relying on only ChatGPT without fact checking may harm your problem solving skills, it can also benefit you when used responsibly!."
        },
        {
          name: 'By fostering curiosity and exploration of new topics',
          explanation: "Almost there! While using ChatGPT responsibly can help generate new topics and be great inspirtation to start off with, it can also negativly impact you when used wrong!"
        },
        {
          name: 'All of the above',
          explanation: "Correct! ChatGPT when used resposibly can be one of your greatest resource if you do not rely on it and fact-check the information. However, if used wrong, it can harm how you think and problem-solve!"
        }
      ],
      answerIndex: 2 //whichever is correct answer so if specificity is correct, it is 0, if politness, it is 1
    },
